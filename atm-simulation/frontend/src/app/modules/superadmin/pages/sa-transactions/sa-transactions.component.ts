...
@Component({
  ...
  template: `
    <div class="page">
      ...
      <div class="table-card">
        <table>
          <thead><tr><th>Reference</th><th>User</th><th>Account</th><th>Type</th><th>Amount</th><th>Balance After</th><th>Status</th><th>Date</th></tr></thead>
          <tbody>
            <tr *ngFor="let t of transactions">
              ...
              <td [class]="t.type === 'withdrawal' ? 'neg' : 'pos'">
            ...
            <tr *ngIf="transactions.length === 0"><td colspan="8" class="empty">No transactions found.</td></tr>
          </tbody>
        </table>
      </div>
    </div>
  ...
  styles: [`
    ...
    .status-success { color:#1e8449; font-weight:600; font-size:12px; }
    .status-failed { color:#c0392b; font-weight:600; font-size:12px; }
    .empty { text-align:center; color:#aaa; padding:32px; }
  `]
})
export class SaTransactionsComponent implements OnInit {
